# `@felixgeelhaar/glossa-sdk` — HTTP fetch + cache + SSE

Stub. Implementation lands after `@felixgeelhaar/glossa-format` is testable.
...
- Build-time pull (consumed by `@felixgeelhaar/glossa-cli`)
