...
/** What the fake edge answers while it serves `r`. */
export const serving = (r: TestRelease): EdgeState => ({
  manifest: { status: 200, etag: `"${r.manifest.release.id}"`, body: r.manifest },
  artifacts: r.bytes,
});
