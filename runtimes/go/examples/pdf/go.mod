module github.com/felixgeelhaar/glossa/runtimes/go/examples/pdf

go 1.26.5

replace (
	github.com/felixgeelhaar/glossa/messageformat => ../../../../messageformat
...
require (
	...
	github.com/felixgeelhaar/glossa/messageformat v0.0.0-00010101000000-000000000000 // indirect
